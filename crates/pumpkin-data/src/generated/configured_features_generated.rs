...
-> std::collections::HashMap<pumpkin_data::configured_feature::ConfiguredFeature, ConfiguredFeature>
{
    ...
    use crate::generation::feature::features::{
        ...
        tree::decorator::{
            ...
            shelf_mushroom::ShelfMushroomTreeDecorator, trunk_vine::TrunkVineTreeDecorator,
        },
        tree::foliage::{
    ...
    map.insert(
        ...
        ConfiguredFeature::FallenTree(FallenTreeFeature {
            ...
            log_decorators: vec![
                ...
                TreeDecorator::ShelfMushroom(ShelfMushroomTreeDecorator {
                    probability: 0.8f32,
                }),
            ],
        }),
            ...
            to_place: BlockStateProvider::NoiseProvider(NoiseBlockStateProvider {
                base: NoiseBlockStateProviderBase {
                    ...
                    noise: DoublePerlinNoiseParametersCodec {
                        first_octave: 0i32,
                        amplitudes: vec![0.955388882960065f64],
                    },
    ...
    map . insert (pumpkin_data :: configured_feature :: ConfiguredFeature :: LargeBasaltColumns , ConfiguredFeature :: WeightedRandomSelector (crate :: generation :: feature :: features :: weighted_random_selector :: WeightedRandomFeature :: new (vec ! [crate :: generation :: feature :: features :: weighted_random_selector :: WeightedFeatureEntry { feature : PlacedFeatureWrapper :: Direct (PlacedFeature { feature : Feature :: Inlined (Box :: new (ConfiguredFeature :: NoOp)) , placement : vec ! [] , }) , weight : 9u32 , } , crate :: generation :: feature :: features :: weighted_random_selector :: WeightedFeatureEntry { feature : PlacedFeatureWrapper :: Direct (PlacedFeature { feature : Feature :: Inlined (Box :: new (ConfiguredFeature :: NoOp)) , placement : vec ! [] , }) , weight : 1u32 , }]))) ;
    map.insert(
    ...
    map . insert (pumpkin_data :: configured_feature :: ConfiguredFeature :: SeagrassMid , ConfiguredFeature :: WeightedRandomSelector (crate :: generation :: feature :: features :: weighted_random_selector :: WeightedRandomFeature :: new (vec ! [crate :: generation :: feature :: features :: weighted_random_selector :: WeightedFeatureEntry { feature : PlacedFeatureWrapper :: Direct (PlacedFeature { feature : Feature :: Inlined (Box :: new (ConfiguredFeature :: SimpleBlock (SimpleBlockFeature { to_place : BlockStateProvider :: Simple (SimpleStateProvider { state : { let mut props = std :: collections :: HashMap :: new () ; props . insert ("half" . to_string () , "lower" . to_string ()) ; BlockStateCodec { name : & pumpkin_data :: Block :: TALL_SEAGRASS , properties : Some (props) , } . get_state () } , }) , schedule_tick : None , }))) , placement : vec ! [PlacementModifier :: BlockPredicateFilter (BlockFilterPlacementModifier { predicate : BlockPredicate :: MatchingBlocks (MatchingBlocksBlockPredicate { offset : OffsetBlocksBlockPredicate { offset : Some (Vector3 :: new (0i32 , 1i32 , 0i32)) } , blocks : MatchingBlocksWrapper :: Single ("minecraft:water" . to_string ()) , }) })] , }) , weight : 60u32 , } , crate :: generation :: feature :: features :: weighted_random_selector :: WeightedFeatureEntry { feature : PlacedFeatureWrapper :: Direct (PlacedFeature { feature : Feature :: Inlined (Box :: new (ConfiguredFeature :: SimpleBlock (SimpleBlockFeature { to_place : BlockStateProvider :: Simple (SimpleStateProvider { state : pumpkin_data :: Block :: SEAGRASS . default_state , }) , schedule_tick : None , }))) , placement : vec ! [] , }) , weight : 40u32 , }]))) ;
    map . insert (pumpkin_data :: configured_feature :: ConfiguredFeature :: SeagrassShort , ConfiguredFeature :: WeightedRandomSelector (crate :: generation :: feature :: features :: weighted_random_selector :: WeightedRandomFeature :: new (vec ! [crate :: generation :: feature :: features :: weighted_random_selector :: WeightedFeatureEntry { feature : PlacedFeatureWrapper :: Direct (PlacedFeature { feature : Feature :: Inlined (Box :: new (ConfiguredFeature :: SimpleBlock (SimpleBlockFeature { to_place : BlockStateProvider :: Simple (SimpleStateProvider { state : { let mut props = std :: collections :: HashMap :: new () ; props . insert ("half" . to_string () , "lower" . to_string ()) ; BlockStateCodec { name : & pumpkin_data :: Block :: TALL_SEAGRASS , properties : Some (props) , } . get_state () } , }) , schedule_tick : None , }))) , placement : vec ! [PlacementModifier :: BlockPredicateFilter (BlockFilterPlacementModifier { predicate : BlockPredicate :: MatchingBlocks (MatchingBlocksBlockPredicate { offset : OffsetBlocksBlockPredicate { offset : Some (Vector3 :: new (0i32 , 1i32 , 0i32)) } , blocks : MatchingBlocksWrapper :: Single ("minecraft:water" . to_string ()) , }) })] , }) , weight : 30u32 , } , crate :: generation :: feature :: features :: weighted_random_selector :: WeightedFeatureEntry { feature : PlacedFeatureWrapper :: Direct (PlacedFeature { feature : Feature :: Inlined (Box :: new (ConfiguredFeature :: SimpleBlock (SimpleBlockFeature { to_place : BlockStateProvider :: Simple (SimpleStateProvider { state : pumpkin_data :: Block :: SEAGRASS . default_state , }) , schedule_tick : None , }))) , placement : vec ! [] , }) , weight : 70u32 , }]))) ;
    map . insert (pumpkin_data :: configured_feature :: ConfiguredFeature :: SeagrassSlightlyLessShort , ConfiguredFeature :: WeightedRandomSelector (crate :: generation :: feature :: features :: weighted_random_selector :: WeightedRandomFeature :: new (vec ! [crate :: generation :: feature :: features :: weighted_random_selector :: WeightedFeatureEntry { feature : PlacedFeatureWrapper :: Direct (PlacedFeature { feature : Feature :: Inlined (Box :: new (ConfiguredFeature :: SimpleBlock (SimpleBlockFeature { to_place : BlockStateProvider :: Simple (SimpleStateProvider { state : { let mut props = std :: collections :: HashMap :: new () ; props . insert ("half" . to_string () , "lower" . to_string ()) ; BlockStateCodec { name : & pumpkin_data :: Block :: TALL_SEAGRASS , properties : Some (props) , } . get_state () } , }) , schedule_tick : None , }))) , placement : vec ! [PlacementModifier :: BlockPredicateFilter (BlockFilterPlacementModifier { predicate : BlockPredicate :: MatchingBlocks (MatchingBlocksBlockPredicate { offset : OffsetBlocksBlockPredicate { offset : Some (Vector3 :: new (0i32 , 1i32 , 0i32)) } , blocks : MatchingBlocksWrapper :: Single ("minecraft:water" . to_string ()) , }) })] , }) , weight : 40u32 , } , crate :: generation :: feature :: features :: weighted_random_selector :: WeightedFeatureEntry { feature : PlacedFeatureWrapper :: Direct (PlacedFeature { feature : Feature :: Inlined (Box :: new (ConfiguredFeature :: SimpleBlock (SimpleBlockFeature { to_place : BlockStateProvider :: Simple (SimpleStateProvider { state : pumpkin_data :: Block :: SEAGRASS . default_state , }) , schedule_tick : None , }))) , placement : vec ! [] , }) , weight : 60u32 , }]))) ;
    map . insert (pumpkin_data :: configured_feature :: ConfiguredFeature :: SeagrassTall , ConfiguredFeature :: WeightedRandomSelector (crate :: generation :: feature :: features :: weighted_random_selector :: WeightedRandomFeature :: new (vec ! [crate :: generation :: feature :: features :: weighted_random_selector :: WeightedFeatureEntry { feature : PlacedFeatureWrapper :: Direct (PlacedFeature { feature : Feature :: Inlined (Box :: new (ConfiguredFeature :: SimpleBlock (SimpleBlockFeature { to_place : BlockStateProvider :: Simple (SimpleStateProvider { state : { let mut props = std :: collections :: HashMap :: new () ; props . insert ("half" . to_string () , "lower" . to_string ()) ; BlockStateCodec { name : & pumpkin_data :: Block :: TALL_SEAGRASS , properties : Some (props) , } . get_state () } , }) , schedule_tick : None , }))) , placement : vec ! [PlacementModifier :: BlockPredicateFilter (BlockFilterPlacementModifier { predicate : BlockPredicate :: MatchingBlocks (MatchingBlocksBlockPredicate { offset : OffsetBlocksBlockPredicate { offset : Some (Vector3 :: new (0i32 , 1i32 , 0i32)) } , blocks : MatchingBlocksWrapper :: Single ("minecraft:water" . to_string ()) , }) })] , }) , weight : 80u32 , } , crate :: generation :: feature :: features :: weighted_random_selector :: WeightedFeatureEntry { feature : PlacedFeatureWrapper :: Direct (PlacedFeature { feature : Feature :: Inlined (Box :: new (ConfiguredFeature :: SimpleBlock (SimpleBlockFeature { to_place : BlockStateProvider :: Simple (SimpleStateProvider { state : pumpkin_data :: Block :: SEAGRASS . default_state , }) , schedule_tick : None , }))) , placement : vec ! [] , }) , weight : 20u32 , }]))) ;
    map . insert (pumpkin_data :: configured_feature :: ConfiguredFeature :: SmallBasaltColumns , ConfiguredFeature :: WeightedRandomSelector (crate :: generation :: feature :: features :: weighted_random_selector :: WeightedRandomFeature :: new (vec ! [crate :: generation :: feature :: features :: weighted_random_selector :: WeightedFeatureEntry { feature : PlacedFeatureWrapper :: Direct (PlacedFeature { feature : Feature :: Inlined (Box :: new (ConfiguredFeature :: NoOp)) , placement : vec ! [] , }) , weight : 9u32 , } , crate :: generation :: feature :: features :: weighted_random_selector :: WeightedFeatureEntry { feature : PlacedFeatureWrapper :: Direct (PlacedFeature { feature : Feature :: Inlined (Box :: new (ConfiguredFeature :: NoOp)) , placement : vec ! [] , }) , weight : 1u32 , }]))) ;
    map.insert(
    ...
    map . insert (pumpkin_data :: configured_feature :: ConfiguredFeature :: SulfurSpring , ConfiguredFeature :: WeightedRandomSelector (crate :: generation :: feature :: features :: weighted_random_selector :: WeightedRandomFeature :: new (vec ! [crate :: generation :: feature :: features :: weighted_random_selector :: WeightedFeatureEntry { feature : PlacedFeatureWrapper :: Direct (PlacedFeature { feature : Feature :: Inlined (Box :: new (ConfiguredFeature :: NoOp)) , placement : vec ! [] , }) , weight : 200u32 , } , crate :: generation :: feature :: features :: weighted_random_selector :: WeightedFeatureEntry { feature : PlacedFeatureWrapper :: Direct (PlacedFeature { feature : Feature :: Inlined (Box :: new (ConfiguredFeature :: NoOp)) , placement : vec ! [] , }) , weight : 90u32 , } , crate :: generation :: feature :: features :: weighted_random_selector :: WeightedFeatureEntry { feature : PlacedFeatureWrapper :: Direct (PlacedFeature { feature : Feature :: Inlined (Box :: new (ConfiguredFeature :: NoOp)) , placement : vec ! [] , }) , weight : 20u32 , } , crate :: generation :: feature :: features :: weighted_random_selector :: WeightedFeatureEntry { feature : PlacedFeatureWrapper :: Direct (PlacedFeature { feature : Feature :: Inlined (Box :: new (ConfiguredFeature :: NoOp)) , placement : vec ! [] , }) , weight : 5u32 , }]))) ;
    map.insert(
    ...
    map . insert (pumpkin_data :: configured_feature :: ConfiguredFeature :: TreesDappledForest , ConfiguredFeature :: WeightedRandomSelector (crate :: generation :: feature :: features :: weighted_random_selector :: WeightedRandomFeature :: new (vec ! [crate :: generation :: feature :: features :: weighted_random_selector :: WeightedFeatureEntry { feature : PlacedFeatureWrapper :: Named (pumpkin_data :: placed_feature :: PlacedFeature :: RedPoplarLeafLitter) , weight : 200u32 , } , crate :: generation :: feature :: features :: weighted_random_selector :: WeightedFeatureEntry { feature : PlacedFeatureWrapper :: Named (pumpkin_data :: placed_feature :: PlacedFeature :: OrangePoplarLeafLitter) , weight : 240u32 , } , crate :: generation :: feature :: features :: weighted_random_selector :: WeightedFeatureEntry { feature : PlacedFeatureWrapper :: Named (pumpkin_data :: placed_feature :: PlacedFeature :: YellowPoplarLeafLitter) , weight : 90u32 , } , crate :: generation :: feature :: features :: weighted_random_selector :: WeightedFeatureEntry { feature : PlacedFeatureWrapper :: Named (pumpkin_data :: placed_feature :: PlacedFeature :: SpruceChecked) , weight : 27u32 , } , crate :: generation :: feature :: features :: weighted_random_selector :: WeightedFeatureEntry { feature : PlacedFeatureWrapper :: Named (pumpkin_data :: placed_feature :: PlacedFeature :: FallenPoplarTree) , weight : 120u32 , }]))) ;
    map.insert(
